...
class my_nanodet():
    ...
    def detect(self, srcimg):
        ...
        cv2.imwrite('./out/result.jpg', srcimg)
        return srcimg
...
if __name__ == '__main__':
    ...
    net = my_nanodet(args.modelpath, prob_threshold=args.confThreshold, iou_threshold=args.nmsThreshold)
